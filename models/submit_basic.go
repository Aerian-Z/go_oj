...
type SubmitBasic struct {
	...
	Status          int           `gorm:"column status; type:int; json:"status"`      // -1-not judged, 1-accepted, 2-wrong answer, 3-time limit exceeded, 4-memory limit exceeded, 5-compilation error
}
